...
class MainScreenState extends State<MainScreen> {
  ...
  Future<void> _fetchBlogs() async {
    try {
      ...
      List<Adventure> tempAdvantures = await getAdventures();
      setState(() {
        _myBlogs = temp;
        _adventures = tempAdvantures;
      });
    } catch (e) {
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                ...
                await saveAdventure(newAdventure); // Ensure blog is saved
                List<Adventure> temp = await getAdventures();
                setState(() {
                  _adventures = temp;
                  // Optionally, update _adventures or other state if necessary
                });
